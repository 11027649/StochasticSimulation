"""
Script for an Md1 and mdn queue
"""
...
mean_joblength = 1                          #average job length, this is fixed for mdn queue
...
class Customer():
    ...
    def get_help(self, env, store):
        """
        Request a service at the store, with a FIFO system
        """
        ...
        with store.resource.request() as req:
            ...
            with open("data/mdn_results.csv", 'a') as resultsFile:
